...
exports.Prueba11722631461783 = void 0;
class Prueba11722631461783 {
    constructor() {
        this.name = 'Prueba11722631461783';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(50) NOT NULL, "password" character varying(60) NOT NULL, "phone" integer NOT NULL, "country" character varying(50) NOT NULL, "address" text NOT NULL, "city" character varying(50) NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
...
exports.Prueba11722631461783 = Prueba11722631461783;
//# sourceMappingURL=1722631461783-prueba1.js.map